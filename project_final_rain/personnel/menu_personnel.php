...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <center>
      <button type="button" class="btn btn-primary" name="button"  onclick="next_New_patient()"><h1>ผู้ป่วยใหม่</h1></button><br><br>
      <button type="button" class="btn btn-warning" name="button"  onclick="next_search_patient()"><h1>ผู้ป่วยเก่า</h1></button><br><br>
      <button type="button" class="btn btn-info" name="button"><h1>คู่มือแบบประเมิน STREAM- Th</h1></button>
    </center>
  </body>
</html>
