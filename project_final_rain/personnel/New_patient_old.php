...
session_start();
  if (!isset($_SESSION['id_card_number'])){
    ...
    $_SESSION['pat_id_card_number'] = $row_get_data['pat_id_card_number']; //hn ที่เลือกไว้
    $_SESSION['check_hos_id'] = $row_get_data['hos_id']; //hos_id ที่เลือกไว้
?>
<!DOCTYPE html>
  ...
  <body>
    <center>
      <table border="1">
        ...
        <tr>
          <th>วันเดือนปีเกิด:*<input type="date"  id="age" name="age" min="1" value="<?php echo  $row_get_data['birthday'];?>"> ปี</th>
          <th>อายุ<?php echo date_diff(date_create($row_get_data['birthday']), date_create('now'))->y;?>ปี</th>
