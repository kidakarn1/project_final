  ...
  <body>
    ...
    <div class="container">
      <div class="table-responsive">
        <table id="assessment_category" class="table table-striped table-bordered">
          <thead>
              <tr>
                <th>ass_cat_id</th>
                <th>ass_cat_name</th>
            ...
            <tr>
              ...
              <td>
                <!-- <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#show">
                  ...
                  <a href="f_edit_assessment_category.php?ass_cat_id=<?php echo $row['ass_cat_id'];?>">แก้ไข</a>
              </td>
              <td>
                  <a href="delete.php?ass_cat_id=<?php echo $row['ass_cat_id'];?>">ลบ</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
