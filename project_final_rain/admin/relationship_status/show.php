...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php
      ...
      include("../../menu.php");
      $sql = "select * from relationship_status";
      $res = $conn->query($sql);
    ?>
    ...
    <div class="container">
      <div class="table-responsive">
        <table id="relationship_status" class="table table-striped table-bordered">
          <thead>
            <tr>
              <th>rel_id</th>
              <th>rel_name</th>
            ...
            <tr>
              ...
              <td>
                <!-- <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#show">
                  ...
                  <a href="f_edit_relationship_status.php?rel_id=<?php echo $row['rel_id'];?>">แก้ไข</a>
              </td>
              <td>
                  <a href="delete.php?rel_id=<?php echo $row['rel_id'];?>">ลบ</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
