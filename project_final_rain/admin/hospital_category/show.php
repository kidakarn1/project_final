  ...
  <body>
    ...
    <div class="container">
      <div class="table-responsive">
        <table id="hospital_category" class="table table-striped table-bordered">
          <thead>
              <tr>
                <th>host_cat_id</th>
                <th>host_cat_name</th>
          ...
          <?php
          $sql = "select * from  hospital_category";
          $res = $conn->query($sql);
          ?>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <!-- <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#show">
                  ...
                  <a href="f_edit_hospital_category.php?host_cat_id=<?php echo $row['host_cat_id'];?>">แก้ไข</a>
              </td>
              <td>
                  <a href="delete.php?host_cat_id=<?php echo $row['host_cat_id'];?>">ลบ</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
