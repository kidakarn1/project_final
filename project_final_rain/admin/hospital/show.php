    ...
    <div class="container">
      <div class="table-responsive">
        <table id="hospital" class="table table-striped table-bordered">
          ...
          <?php
          $sql = "select * from  hospital,hospital_category where
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $row['hos_status']; ?></td>
              <td><?php echo $row['host_cat_name']; ?></td>

              <td>
                <!-- <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#show">
                </button> -->
                  <a href="f_edit_hospital.php?hos_id=<?php echo $row['hos_id'];?>">แก้ไข</a>
              </td>
              <td>
                  <a href="delete.php?hos_id=<?php echo $row['hos_id'];?>">ลบ</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
