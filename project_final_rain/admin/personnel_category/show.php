...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    include("../../menu.php");
    $sql = "select * from personnel_category";
    $res = $conn->query($sql);
    ?>
    ...
    <div class="container">
      <div class="table-responsive">
        <table id="personnel_category" class="table table-striped table-bordered">
          <thead>
              <tr>
                <td>cat_id</td>
                <td>cat_name_eng</td>
            ...
            <tr>
              ...
              <td>
                <!-- <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#show">
                  ...
                  <a href="f_edit_personnel_category.php?cat_id=<?php echo $row['cat_id'];?>">แก้ไข</a>
              </td>
              <td>
                  <a href="delete.php?cat_id=<?php echo $row['cat_id'];?>">ลบ</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
