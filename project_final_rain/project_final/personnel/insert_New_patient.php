<?php
  if (!isset($_POST['hn'])){
    ...
    if ($condition==0){
      $sql_insert_patient = "
        insert into patient(hn, title_id, pat_fname, pat_lname, age, weight, height, career, rel_id, stroke_days,doctor_diagnosis, physical_therapy_diagnosis, important_symptoms_patients, history_of_physical_therapy_treatment,warning, congenital_disease, drug_allergy_history,hos_id,id_card_number)
        VALUES (
        '$hn',
        '$title_id',
        '$pat_fname',
